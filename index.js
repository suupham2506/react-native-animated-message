...
export default class Message extends Component {
  ...
  getColorType() {
    ...
    switch (this.props.messageType) {
      case 'info':
        messageType = { backgroundColor: 'blue' };
        break;

      case 'success':
        messageType = { backgroundColor: 'green' };
        break;

      case 'error':
        messageType = { backgroundColor: 'red' };
        break;

      case 'warning':
        messageType = { backgroundColor: 'gold' };
        break;
    }
    return messageType;
  }
  ...
  render() {
    return this.state.visible ? (
      <View pointerEvents="none" style={[this.getPosition(), styles.container]}>
        <Animated.View
          style={[
